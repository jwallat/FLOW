...
/**
 * Klasse, die die FunktionalitÃ¤t der Informationsausbreitung (Information
 * Expense) enthÃ¤lt. Aufgerufen werden Funnktionen dieser Klasse aus dem
...
public class InformationExpense {
	...
	/**
	 * Gibt eine Liste an Knoten zurï¿½ck, die nach einer gegebenen Anzahl an
