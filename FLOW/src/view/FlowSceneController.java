...
public class FlowSceneController implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		// Initialisiere die Legende der ZentralitÃ¤ten
		try {
	...
	public void highlightCentralitiesCheckBoxClicked() {
		...
		if (highlightCentralitiesCheckBox.isSelected()) {
			...
			// Closeness-Zentralitäten" abfragen moechtest, müsstest du über alle Knoten
			// iterieren und den Zahlenwert der Closeness-Zentralität für deine
			// Anfrage bestimmen.
	 ...
	 * Betweenness-, ClosenesszentralitÃ¤t und den Grad eines Knotens berechnet.
	 */
	public void computeCentralities() {
		// berechne zentralitÃ¤ten
	...
	private void showEdges(String... mode) {
		...
		// nach
		// unten):
		// 1. NameLabels + CentralitÃ¤tslabels
		...
		// entferne Edge-Labels wenn toggleButton nicht ausgewÃ¤hlt
